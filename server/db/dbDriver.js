...
const location = process.env.SQLITE_DB_LOCATION || 'server/controllers/comunitat.db';//'home/pi/db_app/comunitat.db';
const locationBackup = process.env.SQLITE_DB_LOCATION || 'server/controllers/comunitat_backup.db';//'home/pi/db_app/comunitat_backup.db';
