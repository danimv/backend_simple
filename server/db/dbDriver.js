...
const location = process.env.SQLITE_DB_LOCATION || 'home/pi/db_app/comunitat.db';//'home/root/db_app/comunitat.db';
const locationBackup = process.env.SQLITE_DB_LOCATION || 'home/pi/db_app/comunitat_backup.db';//'home/root/db_app/comunitat_backup.db';
